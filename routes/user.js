...
app.post('/signup',authUser.authUser, userHandler.signup);
app.post('/login',authUser.authUser, userHandler.login);
app.post('/verifyOtp',authUser.authUser, userHandler.verifyOtp);
...
app.get('/countrys/:lang',authUser.authUser, userHandler.countrys);
app.get('/getAllStates/:name/:code/:lang', authUser.authUser, userHandler.getAllStates);
...
app.post('/googleLogin',authUser.authUser, userHandler.googleLogin);
...
app.post('/onlineUser',authUser.authUser, userHandler.onlineUser);
