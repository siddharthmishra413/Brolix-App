...
app.get('/soldCoupon/:pageNumber', adminHandler.soldCoupon);
...
app.get('/showListOFCouponWithoutPagination', adminHandler.showListOFCouponWithoutPagination);
...
app.post('/adsfilter/:pageNumber', adminHandler.adsfilter);
app.post('/luckUpgradeCardfilter/:pageNumber', adminHandler.luckUpgradeCardfilter);
app.post('/giftsFilter/:pageNumber', adminHandler.giftsFilter);
app.post('/brolixPaymentFilter/:pageNumber', adminHandler.brolixPaymentFilter);
app.post('/dollorPaymentFilter/:pageNumber', adminHandler.dollorPaymentFilter);
...
app.post('/userfilter/:pageNumber', adminHandler.userfilter);
app.post('/pagefilter/:pageNumber', adminHandler.pagefilter);
