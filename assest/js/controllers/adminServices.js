...
app.service('userService', function($http) {
    ...
    return {
        ...
        adminProfile: function(data) {
            return $http.post(baseurl + '/admin/adminProfile',data);
        },
        ...
        editAds: function(adId, userId, data) {
            console.log("adId at service",adId);
            console.log("userId at service",userId);
            console.log("data at service",JSON.stringify(data));
        ...
        freeViewersPerCashAds: function() {
            return $http.get(baseurl + '/tool/viewBrolixAndDollors/freeViewersPerCashAds/en');
        },

        freeViewersPerCouponAds: function() {
            return $http.get(baseurl + '/tool/viewBrolixAndDollors/freeViewersPerCouponAds/en');
        },
