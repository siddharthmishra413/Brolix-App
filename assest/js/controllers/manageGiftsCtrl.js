...
$scope.top_50_balanc = function(type){
  ...
  $scope.giftTypeName = function(val) {
    ...
    var type = localStorage.getItem('giftTypeName');
    ...
    switch (type)
            {
                ...
                console.log("1"); 
                    userService.giftFilter(data).success(function(res){
                        $scope.totalCouponsGiftShow = res.data;
                ...
                console.log("2");
                    userService.giftFilter(data).success(function(res){
                        $scope.totalCouponsGiftShow = res.data;
                        console.log("ressssssss2",JSON.stringify($scope.totalCouponsGiftShow));
                    })
                ...
                console.log("3");
                    userService.giftFilter(data).success(function(res){
                        $scope.totalCashGiftShow = res.data;
                ...
                console.log("4");
                    userService.giftFilter(data).success(function(res){
                        $scope.totalHiddenGiftShow = res.data;
                ...
                console.log("5");
                    userService.giftFilter(data).success(function(res){
                        $scope.totalExchangedCouponShow1 = res.data;
                ...
                console.log("6"); 
                    userService.giftFilter(data).success(function(res){
                        $scope.totalSentCouponShow1 = res.data;
                ...
                console.log("7");
                    userService.giftFilter(data).success(function(res){
                        $scope.totalSentCashShow = res.data;
